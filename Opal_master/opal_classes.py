...
import sys
sys.path.append('/home/jiaye/Documents/ACSE9/Opal/spud')
import libspud
import datetime
...
def read_in_nirom_options(path, opal_options, nirom_options, fwd_options):
    ...
    if libspud.have_option('/opal_operation/nirom/compression'):
        if libspud.have_option('/opal_operation/nirom/compression/svd_type'):
        ...
        elif libspud.have_option('/opal_operation/nirom/compression/plain_autoencoder'):
            nirom_options.compression.autoencoder = True
            ...
            nsplt = libspud.get_option('/opal_operation/nirom/compression/plain_autoencoder/field_name[0]/nsplt')
            nirom_options.compression.nsplt=nsplt
            generate_directory = libspud.get_option('/opal_operation/nirom/compression/plain_autoencoder/field_name[0]/generate_directory/name')
            nirom_options.compression.generate_directory=generate_directory
            dim = libspud.get_option('/opal_operation/nirom/compression/plain_autoencoder/field_name[0]/dim')
            nirom_options.compression.dim=dim
            file_prefix = libspud.get_option('/opal_operation/nirom/compression/plain_autoencoder/field_name[0]/file_prefix/name')
            nirom_options.compression.file_prefix=file_prefix
            number_epochs = libspud.get_option('/opal_operation/nirom/compression/plain_autoencoder/field_name[0]/number_epochs')
